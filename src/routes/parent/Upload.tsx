...
ถ้าโจทย์ข้อไหนต้องดูรูปภาพ/แผนภาพ/กราฟประกอบถึงจะตอบได้ (ไม่ใช่แค่ข้อความเฉยๆ) ให้เลือกอย่างใดอย่างหนึ่งต่อไปนี้:

1) ถ้ารูปในหน้าที่แนบมาแสดงแผนภาพนั้นชัดเจนอยู่แล้ว ให้ใส่ field "imagePage" เป็นเลขหน้าที่แนบมา (นับจาก 1 ตามลำดับรูปที่แนบ) เช่น ถ้าแผนภาพอยู่ในรูปที่ 2 ให้ใส่ "imagePage": 2

2) ถ้าไม่มีรูปแนบ หรือรูปแนบไม่ชัด ให้วาดแผนภาพนั้นขึ้นมาใหม่เป็น SVG ใส่ใน field "diagramSvg" (ต้องเป็น SVG ที่สมบูรณ์ในตัวเอง เริ่มด้วย <svg viewBox="0 0 400 300" ...> จบด้วย </svg>, ใช้ shape พื้นฐาน เช่น line/rect/circle/text/polygon/marker สำหรับหัวลูกศร, ห้ามมี <script>, ห้ามอ้างอิงไฟล์ภายนอก, ห้ามใช้ CSS class ภายนอก ให้ใส่ style/fill/stroke แบบ inline เท่านั้น) วาดให้ตรงกับตัวเลข/ทิศทาง/ป้ายกำกับในโจทย์ให้แม่นยำที่สุด

ใส่ได้แค่ field ใดfield หนึ่ง (imagePage หรือ diagramSvg) ต่อข้อ ข้อที่ไม่ต้องใช้รูปประกอบไม่ต้องใส่ทั้งสอง field นี้

...
ถ้าโจทย์ข้อไหนต้องดูรูปภาพ/แผนภาพ/กราฟประกอบถึงจะตอบได้ (ไม่ใช่แค่ข้อความเฉยๆ) ให้เพิ่ม field "imagePage" เป็นเลขหน้าที่แนบมา (นับจาก 1 ตามลำดับรูปที่แนบ) เช่น ถ้าแผนภาพอยู่ในรูปที่ 2 ที่แนบมา ให้ใส่ "imagePage": 2 ในข้อนั้น — ข้อที่ไม่ต้องใช้รูปประกอบไม่ต้องใส่ field นี้

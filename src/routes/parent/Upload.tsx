...
ข้อกำหนดของ "diagramSvg": ต้องเป็น SVG ที่สมบูรณ์ในตัวเอง เริ่มด้วย <svg viewBox='0 0 400 300' ...> จบด้วย </svg>, ใช้ shape พื้นฐาน เช่น line/rect/circle/text/polygon/marker สำหรับหัวลูกศร, ห้ามมี <script>, ห้ามอ้างอิงไฟล์ภายนอก, ห้ามใช้ CSS class ภายนอก ให้ใส่ style/fill/stroke แบบ inline เท่านั้น — วาดให้ตรงกับตัวเลข/ทิศทาง/ป้ายกำกับในโจทย์ให้แม่นยำที่สุด เพราะจะใช้แทนรูปต้นฉบับไปเลย
